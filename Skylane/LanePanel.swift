...
class LanePanel: NSPanel {
    ...
    static var contentPanel: LanePanel? {
        NSApp.windows
            .compactMap { $0 as? LanePanel }
            .first { $0.kind == .content }
    }

    static var allPanels: [LanePanel] {
        NSApp.windows.compactMap { $0 as? LanePanel }
    }
